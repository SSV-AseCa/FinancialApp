                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      {isWinner && <Trophy className="w-3.5 h-3.5 text-yellow-500 shrink-0" aria-label="Highest Revenue" />}
                    </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      {isWinner && <Trophy className="w-3.5 h-3.5 text-yellow-500 shrink-0" aria-label="Highest Net Income" />}
                    </div>
              ...
              {comparisonData.companies.map((c) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      <span>{formatCurrency(val)}</span>
                      {isWinner && <Trophy className="w-3.5 h-3.5 text-yellow-500 shrink-0" aria-label="Highest Assets" />}
                    </div>
              ...
              {comparisonData.companies.map((c) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      <span>{formatCurrency(val)}</span>
                      {isWinner && <Trophy className="w-3.5 h-3.5 text-yellow-500 shrink-0" aria-label="Highest Equity" />}
                    </div>
