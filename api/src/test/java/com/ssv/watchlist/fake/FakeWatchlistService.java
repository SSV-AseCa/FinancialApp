...
public class FakeWatchlistService extends WatchlistService {
    ...
    public void respondWith(WatchlistResponse r) { this.response = r; this.error = null; }
    public void respondWithError(RuntimeException e) { this.error = e; this.response = null; }
    public void reset() { this.response = null; this.error = null; }
